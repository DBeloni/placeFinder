...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const svgOlhoFechado = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 19c-7 0-10-7-10-7a13.16 13.16 0 0 1 2.18-3.18L12 12z"></path><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"></path><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"></line><line x1="1" y1="1" x2="23" y2="23"></line></svg>`;
    ...
    const alternarConfirmarSenha = document.getElementById("alternar-confirmar-senha");
    const campoConfirmarSenha = document.getElementById("confirmar-senha");

    if (alternarConfirmarSenha && campoConfirmarSenha) {
        alternarConfirmarSenha.addEventListener("click", () => {
            const ehSenha = campoConfirmarSenha.type === "password";
            campoConfirmarSenha.type = ehSenha ? "text" : "password";
            alternarConfirmarSenha.innerHTML = ehSenha ? svgOlhoFechado : svgOlhoAberto;
        });
    }
});